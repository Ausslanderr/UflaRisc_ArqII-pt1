...
void Controle :: alterarSinais(string opcode) {
    ...
    else if(opcode == "00010001") { // jump and link (jal) b.17                                                    
        Regdst = 0;
        Regwrite = 0;
        Aluctrl = "jal";
        Memread = 0;
    ...
    else if(opcode == "00010010") { // jump register (jr) b.18 
        Regdst = 0;
        Regwrite = 0;
        Aluctrl = "jr";
        Memread = 0;
    ...
    else if(opcode =="00010111") { // set less than immediate b.23
        Regdst = 1;
        Regwrite = 1;
        Aluctrl = "slti";
        Memread = 0;
    ...
    else if(opcode =="00011100") { //subi b.28
        Regdst = 1;
        Regwrite = 1;
        Aluctrl = "subi";
        Memread = 0;
