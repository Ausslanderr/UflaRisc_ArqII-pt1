...
void Wb::leituraEscritaRegistrador(){
	...
	else if(controle->getRegwrite() == 1 and controle->getRegdst() == 1 and alu->getOverflow() == false){
	...
	else if(controle->getRegwrite() == 1 and controle->getRegdst() == 0 and alu->getOverflow() == false){
